...
#Holt Skinner
#Git:holtskinner
#Link código original: https://github.com/holtskinner/PossibilisticCMeans
#----------------
Esta iniciação cientifica é definida por um projeto de pesquisa e analise das particularidades da lógica difusa na tarefa de agrupamento. Durante os estudos são apresentados 6 algoritmos com técnicas diferentes, onde são analisados diversos bancos de dados, gráficos resultados e métricas de validação, contextualizando ao fim duas peculiaridades desta teoria de conjuntos, além de diversos aspectos interessantes sobre cada modelo detalhado.
